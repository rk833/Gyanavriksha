...
import { User, Shield, Monitor, Lock, Loader2, Eye, EyeOff, X, Camera, Smartphone, Mail } from 'lucide-react';
...
export default function StudentSettings() {
  ...
  useEffect(() => {
    if (profile) {
      ...
      setEmail2faEnabled(profile.email_2fa_enabled || false);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-xl border border-primary-light shadow-xl w-full max-w-md p-6">
            ...
            <form onSubmit={handleEmailEnable} className="space-y-3">
              <div>
                <label className="text-xs text-slate-500 uppercase tracking-wider block mb-1">Account password</label>
                <input
                  type="password"
              ...
              <div className="flex gap-2 pt-2">
                ...
                <button type="submit" disabled={enableEmail2faMutation.isPending} className="flex-1 px-4 py-2 bg-primary-dark text-white rounded-lg text-sm font-medium hover:bg-primary disabled:opacity-50 flex items-center justify-center gap-2">
