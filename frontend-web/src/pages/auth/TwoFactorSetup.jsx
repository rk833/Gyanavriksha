    ...
    return (
      <AuthLayout>
        <div className="w-full max-w-md bg-white rounded-xl shadow-sm border border-primary-light p-8 text-center">
          ...
          <p className="mt-4 text-slate-500">Setting up two-factor authentication...</p>
        </div>
      </AuthLayout>
    );
  }
    ...
    return (
      <AuthLayout>
        <div className="w-full max-w-md bg-white rounded-xl shadow-sm border border-primary-light p-8 text-center">
          ...
          <p className="text-slate-500 mb-4">Could not initialize 2FA setup. Please log in first.</p>
          <button
    ...
    return (
      <AuthLayout>
        <div className="w-full max-w-md bg-white rounded-xl shadow-sm border border-primary-light p-8 text-center">
          ...
          <h2 className="text-xl font-bold text-primary-dark mb-2">2FA Enabled!</h2>
    ...
    <AuthLayout>
      <div className="w-full max-w-md bg-white rounded-xl shadow-sm border border-primary-light p-8">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-primary-dark">Two-Factor Authentication</h2>
          <p className="text-slate-500 mt-1">Scan this QR code with your authenticator app</p>
        </div>

        <div className="flex justify-center mb-6">
          <div className="p-3 border-2 border-primary-light rounded-lg">
            <img
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2 bg-background border border-primary-light rounded-lg p-3">
            <code className="flex-1 text-sm font-mono text-primary-dark break-all">{secret}</code>
            <button
              onClick={copySecret}
              className="flex-shrink-0 text-slate-400 hover:text-primary"
            >
        ...
        <div className="bg-primary-light/50 rounded-lg p-4 mb-6 text-sm text-slate-600">
          <p className="font-medium text-primary-dark mb-2">Compatible apps:</p>
        ...
        <form onSubmit={handleVerify} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full text-center text-xl tracking-[0.3em] px-4 py-3 border border-primary-light rounded-lg outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition"
              autoFocus
            />
          </div>
