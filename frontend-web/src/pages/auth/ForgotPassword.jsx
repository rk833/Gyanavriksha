        ...
        <div className="flex items-center justify-center mb-8">
          ...
          <div className="flex items-center gap-2">
            <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold ${
              sent ? 'bg-gray-900 text-white' : 'bg-gray-900 text-white'
            }`}>
              2
            </div>
          ...
          <div className="flex items-center gap-2">
            <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold ${
              sent ? 'bg-gray-900 text-white' : 'bg-gray-200 text-gray-500'
            }`}>
              3
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <div className="absolute left-0 top-0 bottom-0 w-10 flex items-center justify-center border-r border-gray-300 text-gray-400">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-gray-200 transition"
                    autoFocus
                  />
                </div>
              </div>
